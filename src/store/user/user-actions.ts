...
export const signInFailed = withMatcher((error: string) => createAction(USER_ACTION_TYPES.SIGN_IN_FAILED, error));
...
export const signUpSuccess = withMatcher((user: string, additionalDetails: additionalInformation) => createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user, additionalDetails }));

export const signUpFailed = withMatcher((error: string) => createAction(USER_ACTION_TYPES.SIGN_UP_FAILED, error));
...
export const signOutFailed = withMatcher((error: string) => createAction(USER_ACTION_TYPES.SIGN_OUT_FAILED, error));
